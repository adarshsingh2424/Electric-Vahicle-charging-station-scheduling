...
`    if x[1]>=60:
    ...
    for i in range(1,len(l)-1):  
        for j in range(len(l)-1):  
            if l[j][1][0]==l[j+1][1][0] and l[j][1][1]==l[j+1][1][1]:
                if l[j][2][0]<l[j+1][2][0]:l[j],l[j+1]=l[j+1],l[j]
                elif l[j][2][0]==l[j+1][2][0] and l[j][2][1]<l[j+1][2][1]:l[j],l[j+1]=l[j+1],l[j]
    x = [l[1][1][0]+l[1][2][0], l[1][1][1]+l[1][2][1]]
    if x[1] >= 60:
        x = [x[0]+1, x[1]-60]
    if x[0] >= 24:
    ...
    l1.append(l[2]+[2])
    x = [l[3][1][0]+l[3][2][0], l[3][1][1]+l[3][2][1]]
    ...
    l1.append(l[3]+[3])
    x = [l[4][1][0]+l[4][2][0], l[4][1][1]+l[4][2][1]]
    if x[1] >= 60:x = [x[0]+1, x[1]-60]
    if x[0] >= 24:x[0] = x[0]-24
    x[1] = str(x[1])
    l[4][3] = x
    ...
    for i in range(len(l1)-1):
        ...
        l1[1+i].append(a)
        l1[i+1][2]=100-a/10
        l1[i+1][3]=str(l1[i+1][3][0])+":"+str(l1[i+1][3][1])
